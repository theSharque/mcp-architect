...
server.registerTool("get-project-architecture", {
    ...
    description: "Returns project description, module summaries (optional inputs/outputs per module), and dataFlow. Summary inputs/outputs are present when set via set-project-architecture or set-module-details; older data may omit them. For dependencies, files, and usage examples, use get-module-details.",
    inputSchema: {
        projectId: z.string().optional().describe("Project ID (defaults to normalized workdir)"),
    },
    outputSchema: {
...
server.registerTool("set-module-details", {
    ...
    description: "Creates or updates one module: writes the full detail record and syncs name, description, inputs, and outputs into the architecture summary. Does not replace other modules—preferred for incremental updates instead of set-project-architecture.",
    inputSchema: {
        projectId: z.string().optional().describe("Project ID (defaults to normalized workdir)"),
        name: z.string().describe("Module name"),
...
server.registerTool("get-module-details", {
    ...
    description: "Returns the full per-module record (inputs/outputs, dependencies, files, usage examples, notes)—authoritative when the architecture summary is thin or missing optional fields. Use moduleName matching the name in get-project-architecture.",
    inputSchema: {
        projectId: z.string().optional().describe("Project ID (defaults to normalized workdir)"),
